...
public class EscenarioComanda1 {

    public Cerveceria cerveza;

    public EscenarioComanda1(){
        ...
        try {
            ...
            for (int t=0;t<5;t++) {
                    ...
                    //this.cerveza.getMesas().get(t).setEstado("Libre");
            }
            ...
            this.cerveza.eliminarMozo(this.cerveza.getMozos().get(1));
